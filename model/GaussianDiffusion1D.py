...
class GaussianDiffusion1D(nn.Module):
    def __init__(
        ...
        *,
        ...
        super().__init__()
        self.model = model
        self.channels = cfg.z_dim
        # self.channels = self.model.channels  # FIXME:
        # self.self_condition = self.model.self_condition

        self.seq_length = cfg.seq_len
    ...
    def sample(self, batch_size = 16):
        ...
        return sample_fn((batch_size, seq_length, channels))
    ...
    def p_losses(self, x_start, t, noise = None):
        ...
        # FIXME: time embedding?? self condition?? Confer Diffusion-LM codes (mode input)
        # TODO: time embed `timesteps` + positional embedded `x_start` + up-projected `x_start` as in Diffusion-LM/transformer_model2.py Ln902
...
############################
# GaussianDiffusion helper functions
############################
